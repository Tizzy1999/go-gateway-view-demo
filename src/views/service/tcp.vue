    ...
    <el-row>
      <el-card class="box-card">
        <div slot="header" class="clearfix">
          <span v-if="isEdit===false">Create TCP Service</span>
          <span v-if="isEdit===true">Update TCP Service</span>
        </div>
        <div style="margin-bottom:50px;">
          <el-form ref="form" :model="form" label-width="140px">
            ...
            <el-form-item label="Port" class="is-required">
              <el-input v-model="form.port" placeholder="8001-8999" :disabled="isEdit===true" />
            </el-form-item>
